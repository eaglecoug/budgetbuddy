...
if ($fail == "") {
	echo "</head><body>Form data successfully validated: $firstName, $lastName, $username, $password, $email.</body></html>";
...
$db_server = mysql_connect($db_hostname, $db_username, $db_password);
    ...
    add_user($firstName, $lastName, $username, $email);

    function add_user($fn, $sn, $un, $pw, $em)
    {
	$query = "INSERT INTO users VALUES('$fn', '$sn', '$un', '$pw', '$em')";
