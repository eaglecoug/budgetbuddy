...
<div class="container">
  ...
  <div class="sidebar1">
    <ul class="nav">
      ...
      <li><a href="register.php">Ledger</a></li>
  ...
  <div class="content">
    ...
    <p align="center"><!-- end .content -->User Ledger</p>
    <h5 align="left">Add Account</h5>
    <table width="577" align="center" height="248" border="1">
      <tr>
        <th width="134" height="62" scope="col"><h5>Transaction Description</h5></th>
        <th width="128" scope="col"><h5>Transaction Amount</h5></th>
        <th width="145" scope="col"><h5>Ending Balance</h5></th>
        <th width="142" scope="col"><h5>Date</h5></th>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
